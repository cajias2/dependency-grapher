 ...
 * 
 */
public class PickableEdgeWriteTransformer<V,E> implements Transformer<E,Paint> {
     ...
     */
    public PickableEdgeWriteTransformer(PickedInfo<E> pi, Paint draw_paint, Paint picked_paint) {
        if (pi == null)
